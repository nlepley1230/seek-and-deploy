       ...
       var gaugeData = [{
        domain: { x: [0, 1], y: [0, 1] },
         ...
         gauge: {
          ...
          steps: [
            { range: [0, 2], color: "RGB(241, 248, 233)" },
            { range: [2, 4], color: "RGB(220, 237, 200 )" },
            {range: [4,6], color: 'RGB(197, 225, 165)'},
            {range: [6,8], color: 'RGB(174, 213, 129)'},
            {range: [8,10], color: 'RGB(156, 204, 101)'}
          ]
